...
public class Cart : MonoBehaviour
{
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        Gizmos.DrawLine(transform.position - new Vector3(vehicleWidth * 0.5f, 0.5f, 0),transform.position + new Vector3(vehicleWidth * 0.5f, -0.5f, 0)); // текущее положение - половина ширины транспорта. и вниз 0.5
    }
